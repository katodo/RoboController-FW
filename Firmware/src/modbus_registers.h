...
/* *****************************************************************************
 ...
 WORD_STATUSBIT2 è salvata in EEPROM
 ******************************************************************************/
 ...
 * \brief Controlla la polarità del segnale di Enable verso il driver del motore. Se "0" il driver è attivo basso, se "1" il driver è attivo con Enable = "1"
 */
#define FLG_EEPROM_OUTPUT_DRIVER_ENABLE_POLARITY     0x0002  //!< Controlla la polarità del segnale di Enable verso il driver del motore. Se "0" il driver è attivo basso, se "1" il driver è attivo con Enable = "1"
...
\brief	( R ) Tempo espresso in mSec che il dispositivo attende prima di inviare
	la risposta é particolarmente importante in caso di collegamenti Wireless
...
\brief 	( R/W ) Word utilizzata a BIT per abilitare/disabilitare le varie funzioni della scheda.
	...
	*  - WORD_STATUSBIT1.0 : Flag \ref FLG_JOYMODE, modalità RoboController/JoyStick
	*      Se a 1 RoboController in modalità joystick manuale, ai motori vengono inviati direttamente
	...
	*      loro velocità. I motori non sono disattivati e basta riscrivere la velocità per ripartire,
...
// Velocità angolare della ruota in rad/Sec
#define WORD_ROBOT_WHEEL_SPEED_LEFT             50
#define WORD_ROBOT_WHEEL_SPEED_RIGHT            51

// Velocità lineare del robot in mm/Sec
...
#define WORD_ROBOT_ENCODER_CPR_LEFT             207 // Numero di impulsi encoder per rivoluzione della ruota ( già moltiplicato per 4 )
#define WORD_ROBOT_ENCODER_CPR_RIGHT            208 // Numero di impulsi encoder per rivoluzione della ruota ( già moltiplicato per 4 )
